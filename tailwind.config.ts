		...
		extend: {
			...
			keyframes: {
				...
				'image-glow': {
					...
					'50%': { 'background-size': '120% 120%', opacity: '0.8' },
			...
			fontSize: {
				...
				'display-medium': ['2.8rem', { lineHeight: '1.1', letterSpacing: '-0.02em' }],
				'display-small': ['2.2rem', { lineHeight: '1.2', letterSpacing: '-0.01em' }],
			},
			backgroundImage: {
